...
class UserProfileTable: UIViewController, UITableViewDelegate, UITableViewDataSource {
  ...
  @IBOutlet weak var userPersonalProfileView: UIView!
  ...
  override func viewDidLoad() {
    ...
    userPersonalProfileView.layer.borderColor = UIColor.gray.cgColor
    userPersonalProfileView.layer.borderWidth = 3
    userPersonalProfileView.layer.cornerRadius = userPersonalProfileView.frame.height/2
